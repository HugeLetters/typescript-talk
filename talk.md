...
Контрвариативность в квадрате, кстати, дает ковариативность - если мы определим такой дженерик, возвращающий функцию, которая принимает на вход другую функцию, которая принимат на вход указанный тип, то контрвариативности, так сказать, отменят друг друга. Первый уровень контрвариативности в том, что у нас функция с параметром, а второй уровень контрвариативности в том, что этот параметр - это функция, принимающая на вход параметр указанного типа.
...
Ну и чтобы подвести итоги. Это две концепции - то, что типы это множества, и вариативность с ее подвидами, - это основы, которые я думаю, дают хорошую базу для понимания более продвинутых фичей в Тайпскрипте. Это далеко не все, что есть - я не затрагивал дистрибьютивность, `infer`, `satisfies`, `template literals`, `conditional types` или `higher-kinded types`. Но это уже все же конкретные фичи - я хотел рассказать про две главных абстрактных идеи, которые сильно помогут разобраться со всем остальным.
